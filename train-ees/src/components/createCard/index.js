            ...
            <div className='cardBody'>
                <div className='mediaItems'>
                    <div className='linkedin'>
                        <img src={linkedin} alt="linkedin" /><input type='text' placeholder='linkedin link' onChange={(e) => {props.linkedinChange(e.target.value) }} />
                    </div>
                    <div className='github'>
                        <img src={github} alt="github" /><input type='text' placeholder='github' onChange={(e) => { props.githubChange(e.target.value) }} />
                    </div>
                    <div className='phone'>
                        <img src={phone} alt="phone" /><input type='text' placeholder='phone' onChange={(e) => { props.phoneChange(e.target.value) }} />
                    </div>
                    <div className='email'>
